...
class TestUPIDAPIClient:
    ...
    @pytest.mark.unit
    def test_api_client_custom_config(self, mock_config):
    ...
    @pytest.mark.unit
    def test_get_auth_headers_with_token(self, mock_config):
        """Test getting auth headers with token"""
        client = UPIDAPIClient(mock_config)
        mock_config.set_auth_token('test_token_123')
    ...
    @pytest.mark.unit
    def test_get_auth_headers_without_token(self, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_login_failure(self, mock_post, mock_config):
        """Test login failure"""
        client = UPIDAPIClient(mock_config)
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_logout_success(self, mock_post, mock_config):
    ...
    def test_get_profile_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_refresh_token_success(self, mock_post, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_get')
    def test_get_clusters_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_get')
    def test_get_cluster_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_create_cluster_success(self, mock_post, mock_config):
    ...
    def test_delete_cluster_success(self, mock_delete, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_optimize_cluster_success(self, mock_post, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_get')
    def test_get_optimization_result_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_post')
    def test_deploy_optimization_success(self, mock_post, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_get')
    def test_get_deployment_status_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    @patch.object(UPIDAPIClient, '_get')
    def test_get_cost_analysis_success(self, mock_get, mock_config):
    ...
    @pytest.mark.unit
    def test_handle_response_success(self, mock_config):
    ...
    @pytest.mark.unit
    def test_handle_response_error(self, mock_config):
    ...
    @pytest.mark.unit
    def test_handle_response_json_error(self, mock_config):
